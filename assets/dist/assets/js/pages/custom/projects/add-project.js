					...
					if (result.value) {
						...
						$.ajax({
							...
							data: {
								...
								'rencana_awal': $('#rencana_awal').val(),
								'rencana_akad': $('#rencana_akad').val(),
								'berita': $('#berita').val(),
								[csrf_name]: csrf_token
							},
							beforeSend: function() {
								$('#simpan').html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> <i>sedang menyimpan ...</i>');
								$('#simpan').attr('disabled', 'disabled');
							},
							success: function(response) {
								$('#simpan').html('Submit');
								$('#simpan').removeAttr('disabled');
								$('input[name=sinergi_token]').val(response.token);

...
class M_foto extends CI_Model {
    ...
    var $table = 'em_foto'; //nama tabel dari database
    var $column_order = array(null,null, 'judul','status',null); //field yang ada di table user
    var $column_search = array('judul','status'); //field yang diizin untuk pencarian 

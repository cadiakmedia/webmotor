...
class M_foto_akad extends CI_Model {
 
    var $table = 'em_akad_foto'; //nama tabel dari database
    var $column_order = array(null,null, 'foto','slug','konten',null); //field yang ada di table user
    var $column_search = array('foto','slug','konten'); //field yang diizin untuk pencarian 
    ...
    private function _get_datatables_query($id_akad)
    {
    ...
    function get_datatables($id_akad)
    {
        $this->_get_datatables_query($id_akad);
        if($_POST['length'] != -1)

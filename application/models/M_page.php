...
class M_page extends CI_Model {
    ...
    var $table = 'em_page'; //nama tabel dari database
    var $column_order = array(null,null, 'judul','slug',null); //field yang ada di table user
    var $column_search = array('judul','slug'); //field yang diizin untuk pencarian 

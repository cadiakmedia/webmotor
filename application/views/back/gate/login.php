...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="<?= base_url('assets/dist/'); ?>assets/css/pages/login/login-2.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				...
				<div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
					...
					<div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
						...
						<a href="#" class="text-center pt-2">
							<img src="<?= base_url()?>assets/img/logo.png" class="max-h-100px" alt="" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside body-->
                ...
                <?= $this->session->flashdata('message'); ?>
								<form class="form" action="<?php echo base_url('gate\login'); ?>" method="post" id="kt_login_signin_form">
								<input type="hidden" class="txt_csrfname" name="<?=$csrf_name;?>" value="<?=$csrf_hash;?>" />
									...
									<div class="text-center pt-2">
										<button type="submit" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">LogIn</button>
									</div>
									<!--end::Action-->
								</form>
								<!--end::Form-->
                ...
                <?= $this->session->flashdata('message'); ?>
                    ...
                    <p class="text-muted font-weight-bold font-size-h4"><?php echo validation_errors(); ?></p>
                    
									</div>
									<!--end::Title-->
									<!--begin::Form group-->
									<div class="form-group">
										<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="text" placeholder="Username" name="username"  />
									</div>
                  <div class="form-group">
										<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="password" placeholder="Password" name="password1"  />
									</div>
                  <div class="form-group">
										<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="password" placeholder="Re-type password" name="password2"  />
									</div>
									<!--end::Form group-->
									<!--begin::Form group-->
				...
				<div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #B1DCED;">
					...
					<div class="d-flex flex-column justify-content-center text-center pt-lg-40 pt-md-5 pt-sm-5 px-lg-0 pt-5 px-7">
						<h3 class="display4 font-weight-bolder my-7 text-dark" style="color: #986923;">Website Solusi Ummat</h3>
						
						
					</div>
					<!--end::Title-->
					<!--begin::Image-->
					<div class="content-img d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center" style="background-image: url(<?= base_url('assets/dist/'); ?>assets/media/svg/illustrations/login-visual-2.svg);"></div>
					<!--end::Image-->
				</div>
				<!--end::Content-->
			</div>
		...
		<script src="<?= base_url('assets/dist/'); ?>assets/js/pages/custom/login/login-general.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>

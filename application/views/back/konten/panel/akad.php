...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                 ...
                 <button id='btnGroupDrop1' type='button' class='btn btn-primary font-weight-bold ' data-target="#form_akad" data-toggle="modal" aria-haspopup='true' >
...
</svg><!--end::Svg Icon--></spdan>Tambah Akad</button>

  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
     ...
     <input type="hidden" class="txt_csrfname" name="<?=$csrf_name;?>" value="<?=$csrf_hash;?>" />
      <input type="hidden" id="id_akad" class="form-control" value="<?= $data_akad['id']?>"  name="id_akad"/>
      <div class="form-group col-12">
      <label>Judul Akad<span class="text-danger">*</span>:</label>
      <input type="text" id="judul_edit" class="form-control" name="judul_edit" value="<?= $data_akad['judul']?>" placeholder="Input Judul Page" required="required" />
       
      </div>
     
      <div class="form-group col-12">
                            <label>Konten<span class="text-danger">*</span>:</label>
                            <textarea  id="konten_edit" class="form-control" name="konten_edit" placeholder="Input Konten Page" required="required"><?= $data_akad['konten']?></textarea>			
                        </div>

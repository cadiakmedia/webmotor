...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="form-group col-12">
                        ...
                        <div id="foto">
                            <img src="<?= base_url()?>galery/<?= $data_page['featur_image']?>">
                    ...
                    <div class="form-group col-12">
                            ...
                            <input type="text" id="judul" class="form-control" name="judul" value="<?= $data_page['judul']?>" placeholder="Input Judul Page" required="required" />
                            <input type="hidden" id="id" class="form-control" name="id" value="<?= $data_page['id']?>" placeholder="Input Judul Page" required="required" />
                        </div>
             
                <div class="form-group col-12">
                            <label>Konten<span class="text-danger">*</span>:</label>
                            <textarea  id="konten" class="form-control" name="konten" placeholder="Input Konten Page" required="required"><?= $data_page['konten']?></textarea>			
                        </div>

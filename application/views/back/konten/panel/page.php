...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                 ...
                 <button id='btnGroupDrop1' type='button' class='btn btn-primary font-weight-bold ' data-target="#form_page" data-toggle="modal" aria-haspopup='true' >
...
</svg><!--end::Svg Icon--></spdan>Tambah Page</button>
...
<!-- Modal -->
<div class="modal fade" id="form_page" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Input data Page</h5>
      ...
      <div class="form-group col-12">
				<label>Slug Page<span class="text-danger">*</span>:</label>
 ...
 <div class="modal fade" id="edit_page" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
 ...
 <div class="modal fade" id="view_page" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit data page</h5>
      ...
      <div class="form-group col-12">
      <label>Judul Page<span class="text-danger">*</span>:</label>
      <input type="text" id="judul_view" class="form-control" name="judul_edit" placeholder="Input Judul Page" required="required" readonly />

      </div>
      <div class="form-group col-12">
      <label>Slug Page<span class="text-danger">*</span>:</label>
      <input type="text" id="slug_view" class="form-control" name="slug_edit" placeholder="Input Slug Page" required="required" readonly />				
      </div>
      <div class="form-group col-12">
      <label>Konten<span class="text-danger">*</span>:</label>

...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                 ...
                 <a href="<?= base_url()?>panel/page/tambah"><button id='btnGroupDrop1' type='button' class='btn btn-primary font-weight-bold' >
...
</svg><!--end::Svg Icon--></spdan>Tambah Page</button></a>

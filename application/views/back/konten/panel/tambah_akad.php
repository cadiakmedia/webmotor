...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="card-footer">
                    <input type="submit" onclick="tinyMCE.triggerSave(true,true);" id="submit-form2" class="btn btn-primary submit-formrounded-pill float-right mb-5 ml-3" value="Submit Data Akad">

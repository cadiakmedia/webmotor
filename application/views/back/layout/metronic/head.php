...
<head>
    ...
    <title>SOLUSI UMMAT INDONESIA - <?= $page_title; ?></title>

    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
    <meta name="description" content="SOLUSI UMMAT INDONESIA">
    <meta name="author" content="Solusi Ummat Indonesia">
    <!--begin::Fonts-->
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url('assets/addons/img/favicon-sinergi.png'); ?>">

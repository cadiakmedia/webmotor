...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold m-0">Profile Pengguna
        </h3>
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url('<?= base_url('public/foto/').$value->foto_user?>')"></div>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="navi mt-2">
                    ...
                    <a  data-toggle="modal" data-target="#logoutModal" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
                </div>
            </div>
        </div>
        <div class="separator separator-dashed mt-8 mb-5"></div>
        <div class="navi navi-spacer-x-0 p-0">
            <a href="<?= base_url('panel/profil')?>" class="navi-item">
                <div class="navi-link">
